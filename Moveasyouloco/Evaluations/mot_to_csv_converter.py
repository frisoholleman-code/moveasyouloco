...
parser = argparse.ArgumentParser(description='convert .mot file to .csv')
parser.add_argument('--path', type=str, required=True, help='Path to the .mot file')
parser.add_argument('--outputpath', type=str, required=True, help='Path to the output .csv file')
...
mot_to_csv_pandas(args.path, args.outputpath)